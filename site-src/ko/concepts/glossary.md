...
### 게이트웨이 컨트롤러 (Gateway Controller) {#gateway-controller}
...
### 동/서 트래픽 (East/West traffic) {#eastwest-traffic}

클러스터 내부 워크로드 간 트래픽

### 엔드포인트 라우팅 (Endpoint routing) {#endpoint-routing}
...
### 북/남 트래픽 (North/South traffic) {#northsouth-traffic}
...
### 서비스 메시 (Service mesh) {#service-mesh}
...
### 서비스 라우팅 (Service routing) {#service-routing}
