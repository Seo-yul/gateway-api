...
환경에 따라 한 사람이 여러 역할을 맡을 수 있다는 것을 유의하자.
이는 아래에서 논의한다.

## 주요 역할과 페르소나 <a name="key-roles-and-personas"></a>
...
* **Chihiro**<a name="Chihiro"></a><a name="chihiro"></a> (그들/그들의)은 _클러스터 운영자_ 로서,
...
- 보다 일반적인 소규모 스타트업의 경우, 클라우드 제공업체의 클러스터를 사용할 것이다.
  이 경우 Ana와 Chihiro는 같은 사람이 수 있으며,
  Ian은 클라우드 제공자 내의 직원(또는 자동화 프로세스!)일 수 있다.
