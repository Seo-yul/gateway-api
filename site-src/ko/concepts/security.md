...
## 역할과 페르소나 <a name="roles-and-personas"></a>
...
ReferenceGrant에 대한 자세한 내용은 [이 리소스에 대한 상세 문서](../api-types/referencegrant.md)를
참조하자.
...
라우트 또는 리스너셋의 [호스트네임 정의](../../reference/spec.md#httproutespec)는
목록이며, 다음 시나리오를 고려하자.
...
### 네임스페이스 간 참조 제한 <a name="limiting-cross-namespace-references"></a>

리소스 소유자는 [ReferenceGrant](../api-types/referencegrant.md)의 사용에
대해 인지하고 있어야 한다.
