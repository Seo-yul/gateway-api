...
## 사용 사례 목록 {#use-case-list}

- [사용 사례](#use-cases)
  - [사용 사례 목록](#use-case-list)
  - [기본 북/남(North/South) 사용 사례](#basic-ns)
  - [단일 게이트웨이 뒤에 여러 애플리케이션](#multi-app)
  - [기본 동/서(East/West) 사용 사례](#basic-ew)
  - [게이트웨이와 메시 결합 사용 사례](#gateway-mesh)

[역할과 페르소나]:roles-and-personas.md

## 기본 [북/남] 사용 사례 {#basic-ns}
...
이 사례는
[기본 북/남 사용 사례](#basic-ns)와 놀라울 정도로 유사하지만,
여러 애플리케이션 팀이 존재한다.
...
이는 사실상
[단일 게이트웨이 뒤에 여러 애플리케이션이 있는 경우](#multi-app)와 [기본 동/서 사용 사례](#basic-ew)를
결합한 형태다.
