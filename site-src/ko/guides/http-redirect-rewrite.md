...
[HTTPRoute 리소스](../api-types/httproute.md)는
[필터](../api-types/httproute.md#filters-optional)를 사용하여
...
가져오도록 지시한다.
[`RequestRedirect` 규칙 필터](../../reference/spec.md#httprequestredirectfilter)는
...
[`URLRewrite` 필터](../../reference/spec.md#httpurlrewritefilter)는
