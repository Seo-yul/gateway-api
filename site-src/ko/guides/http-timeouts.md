...
???+ info "확장 지원 기능: HTTPRouteRequestTimeout"
    이 기능은 확장 지원(Extended Support)의 일부이다. 지원 수준에 대한 자세한 내용은 [적합성 가이드](../concepts/conformance.md)를 참조한다.

[**HTTPRoute**(HTTP라우트) 리소스](../api-types/httproute.md)는
